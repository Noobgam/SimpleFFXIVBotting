...
local CONFIG = {
    ...
    jobQuestCompletion = {
        ...
        [80] = {
            [FFXIV.JOBS.PALADIN] = 3210,
            [FFXIV.JOBS.WARRIOR] = 3212,
            [FFXIV.JOBS.DARKKNIGHT] = 3221,
            [FFXIV.JOBS.GUNBREAKER] = 3225,
            [FFXIV.JOBS.DRAGOON] = 3213,
            [FFXIV.JOBS.MONK] = 3211,
            [FFXIV.JOBS.NINJA] = 3219,
            [FFXIV.JOBS.SAMURAI] = 3223,
            [FFXIV.JOBS.REAPER] = 4078,
            [FFXIV.JOBS.BARD] = 3214,
            [FFXIV.JOBS.MACHINIST] = 3220,
            [FFXIV.JOBS.DANCER] = 3226,
            [FFXIV.JOBS.WHITEMAGE] = 3215,
            [FFXIV.JOBS.SCHOLAR] = 3218,
            [FFXIV.JOBS.ASTROLOGIAN] = 3222,
            [FFXIV.JOBS.SAGE] = 4072,
            [FFXIV.JOBS.BLACKMAGE] = 3216,
            [FFXIV.JOBS.SUMMONER] = 3217,
            [FFXIV.JOBS.REDMAGE] = 3224,
            [FFXIV.JOBS.PICTOMANCER] = 4855,
            [FFXIV.JOBS.VIPER] = 4849,
        },
    },
    roleQuestCompletion = {
        [70] = {
